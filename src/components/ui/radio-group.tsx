...
>(({ className, children, ...props }, ref) => {
  return (
    ...
    >
      {/* Shadow layer */}
      <span className="absolute top-0 left-0 w-full h-full rounded-full bg-black/25 will-change-transform transition-transform duration-300 ease-in-out translate-y-0.5 group-hover:translate-y-1 group-active:translate-y-px" />
      ...
      <span className={cn(
        ...
        "will-change-transform transition-transform duration-300 ease-in-out -translate-y-1",
